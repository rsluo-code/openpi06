...
episode_dir = "/wx-mix01/sppro/permanent/yuanzhang10/资源部传输数据/抓物品/V4新规则抓取/LD_抓物品_all_0930_1114/zd3/1009_04_茶饮_LD_冰红茶_197/bg_tablecloth1:arm_right:object_1/episode_2025-10-09_10:46:47_583"
...
def eval_isaac(args: Args) -> None:
    ...
    for episode_idx in tqdm.tqdm(range(args.num_trials_per_task)):
        ...
        if joint1:
            ...
            plt.tight_layout()
            plt.savefig('/DATA/disk1/1024_grasp_packages/code/pi0_code/val_SF_results/episode_2025-11-03_095210_708_v4.png')
            plt.show()
        else:
