...
XLA_PYTHON_CLIENT_MEM_FRACTION=0.9 XLA_FLAGS="--xla_gpu_autotune_level=0" python scripts/train.py linden_jfni3 --exp-name=test --overwrite
XLA_FLAGS="--xla_gpu_autotune_level=0" python scripts/serve_policy.py policy:checkpoint --policy.config=linden_jfni3 --policy.dir=/b3-mix03/sppro/permanent/jfni3/pi05_checkpoints/linden_jfni3/sl_0914/20000