...
class DualArmFK:
    ...
    def __del__(self):
        cleanup_robot(self.robot_id, self.physics_client)
...
if __name__ == '__main__':
    ...
    cur_joint = [0.2661256492137909, 1.199920415878296, -2.059926986694336, 0.1647585779428482, 1.235488772392273, -0.05688488483428955]
    print("pose:", fk.set_joint_states_get_pose(cur_joint,base_tip_link_index=0))   # -> [x,y,z,qw,qx,qy,qz]

# 0.2083688413578547, -0.004382630614149908, -0.07140612326013909, 0.7304797971646753, -0.007093451183027943, -0.6828535985026895, -0.00774027754648152
# 0.0572	1.90E-05	0.212827	0.007101822	0.682829002	0.007755505	0.730502546
